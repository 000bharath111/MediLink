...
st.set_page_config(page_title="🩺 MediLink", page_icon="🩺")
...
# Footer
st.markdown("---")
st.caption("🩺 MediLink | Powered by The Gale Encyclopedia of Medicine 3rd Edition | Not for medical diagnosis")
